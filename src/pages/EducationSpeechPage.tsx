...
const videos = [
    ...
    { title: "Persuasion Basics", desc: "Simple techniques to be more convincing." },
    { title: "Storytelling", desc: "Make your speech memorable with stories." },
    { title: "Public Speaking Drills", desc: "Short exercises you can repeat daily." },
];

const EducationSpeechPage = () => {
    const { t } = useLanguage();
...
export default EducationSpeechPage;
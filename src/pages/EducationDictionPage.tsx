...
const videos = [
    ...
    { title: "Speed Control", desc: "Speak fast but stay understandable." },
    { title: "Vocal Tone", desc: "Train a pleasant and confident voice." },
    { title: "Articulation Drills", desc: "Daily drills for crisp speech." },
];

const EducationDictionPage = () => {
    const { t } = useLanguage();
...
export default EducationDictionPage;